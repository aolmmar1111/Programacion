...
public class NuevoMain {
    public static void main(String[] args) {
        ...
        Prestamo prestamo1 = new Prestamo(LocalDate.now(),l2,est1,1);
        Prestamo prestamo2 = new Prestamo(LocalDate.now(),l1,est1,2);
        Prestamo prestamo3 = new Prestamo(LocalDate.now(),l4,est4,3);
        ...
        do {
            ...
            switch (eleccionMenu){
                ...
                case "3" -> {
                    ...
                    Prestamo prestamonuevo = new Prestamo(LocalDate.now(),libroPrestamo,estudiantePrestamo, 0);
